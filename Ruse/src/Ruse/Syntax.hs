module Ruse.Syntax where

--
--
-- Abstract Syntax Tree for Ruse
--
--
data RExpr = NumC Int
           | BoolC Bool
...
--
-- Note that this substitution operation doesn't take the name of the variable
-- we are substituting for, and in general, our AST does not mention variable
-- names. (For instance, we represent functions as `Lam e`, not `Lam "x" e`.) To
-- manage free variables and shadowing, we are using an encoding called De
-- Bruijn indices. You shouldn't have to know anything about this encoding, but
-- you can read about this simple technique here:
--
